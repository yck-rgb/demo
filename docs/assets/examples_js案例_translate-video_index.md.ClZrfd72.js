...
<span class="line"><span>},</span></span></code></pre></div>`,7),te=JSON.parse('{"title":"视频转换","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"examples/js案例/translate-video/index.md","filePath":"examples/js案例/translate-video/index.md"}'),K={name:"examples/js案例/translate-video/index.md"},se=Object.assign(K,{setup(s){return(e,t)=>{const a=S("show-code");return U(),I("div",null,[H,J,Q,D(q),D(a,{code:y(z)},null,8,["code"]),Y])}}});export{te as __pageData,se as default};
