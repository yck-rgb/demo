...
<\/script>\r
`,b=y("",3),E=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/js案例/eye-dropper/index.md","filePath":"examples/js案例/eye-dropper/index.md"}'),x={name:"examples/js案例/eye-dropper/index.md"},g=Object.assign(x,{setup(l){return(e,o)=>{const t=s("show-code");return a(),p("div",null,[b,n(v),n(t,{code:c(D)},null,8,["code"])])}}});export{E as __pageData,g as default};
