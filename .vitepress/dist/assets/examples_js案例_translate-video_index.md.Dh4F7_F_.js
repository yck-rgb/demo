var B=Object.defineProperty;var S=(r,e,t)=>e in r?B(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var i=(r,e,t)=>(S(r,typeof e!="symbol"?e+"":e,t),t),I=(r,e,t)=>{if(!e.has(r))throw TypeError("Cannot "+t)};var n=(r,e,t)=>(I(r,e,"read from private field"),t?t.call(r):e.get(r)),f=(r,e,t)=>{if(e.has(r))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(r):e.set(r,t)},w=(r,e,t,a)=>(I(r,e,"write to private field"),a?a.call(r,t):e.set(r,t),t);import{d as j,s as k,_ as P,o as T,c as N,j as u,t as F,F as x,D as $,I as C,k as W,a as M,aR as G}from"./chunks/framework.9Bysw7YS.js";var s;(function(r){r.LOAD="LOAD",r.EXEC="EXEC",r.WRITE_FILE="WRITE_FILE",r.READ_FILE="READ_FILE",r.DELETE_FILE="DELETE_FILE",r.RENAME="RENAME",r.CREATE_DIR="CREATE_DIR",r.LIST_DIR="LIST_DIR",r.DELETE_DIR="DELETE_DIR",r.ERROR="ERROR",r.DOWNLOAD="DOWNLOAD",r.PROGRESS="PROGRESS",r.LOG="LOG",r.MOUNT="MOUNT",r.UNMOUNT="UNMOUNT"})(s||(s={}));const V=(()=>{let r=0;return()=>r++})(),H=new Error("ffmpeg is not loaded, call `await ffmpeg.load()` first"),X=new Error("called FFmpeg.terminate()");var d,m,p,R,E,_,l;class z{constructor(){f(this,d,null);f(this,m,{});f(this,p,{});f(this,R,[]);f(this,E,[]);i(this,"loaded",!1);f(this,_,()=>{n(this,d)&&(n(this,d).onmessage=({data:{id:e,type:t,data:a}})=>{switch(t){case s.LOAD:this.loaded=!0,n(this,m)[e](a);break;case s.MOUNT:case s.UNMOUNT:case s.EXEC:case s.WRITE_FILE:case s.READ_FILE:case s.DELETE_FILE:case s.RENAME:case s.CREATE_DIR:case s.LIST_DIR:case s.DELETE_DIR:n(this,m)[e](a);break;case s.LOG:n(this,R).forEach(o=>o(a));break;case s.PROGRESS:n(this,E).forEach(o=>o(a));break;case s.ERROR:n(this,p)[e](a);break}delete n(this,m)[e],delete n(this,p)[e]})});f(this,l,({type:e,data:t},a=[],o)=>n(this,d)?new Promise((c,h)=>{const g=V();n(this,d)&&n(this,d).postMessage({id:g,type:e,data:t},a),n(this,m)[g]=c,n(this,p)[g]=h,o==null||o.addEventListener("abort",()=>{h(new DOMException(`Message # ${g} was aborted`,"AbortError"))},{once:!0})}):Promise.reject(H));i(this,"load",({classWorkerURL:e,...t}={},{signal:a}={})=>(n(this,d)||(w(this,d,e?new Worker(new URL(e,import.meta.url),{type:"module"}):new Worker(new URL("/demo/assets/worker-lPYB70QI.js",import.meta.url),{type:"module"})),n(this,_).call(this)),n(this,l).call(this,{type:s.LOAD,data:t},void 0,a)));i(this,"exec",(e,t=-1,{signal:a}={})=>n(this,l).call(this,{type:s.EXEC,data:{args:e,timeout:t}},void 0,a));i(this,"terminate",()=>{const e=Object.keys(n(this,p));for(const t of e)n(this,p)[t](X),delete n(this,p)[t],delete n(this,m)[t];n(this,d)&&(n(this,d).terminate(),w(this,d,null),this.loaded=!1)});i(this,"writeFile",(e,t,{signal:a}={})=>{const o=[];return t instanceof Uint8Array&&o.push(t.buffer),n(this,l).call(this,{type:s.WRITE_FILE,data:{path:e,data:t}},o,a)});i(this,"mount",(e,t,a)=>{const o=[];return n(this,l).call(this,{type:s.MOUNT,data:{fsType:e,options:t,mountPoint:a}},o)});i(this,"unmount",e=>{const t=[];return n(this,l).call(this,{type:s.UNMOUNT,data:{mountPoint:e}},t)});i(this,"readFile",(e,t="binary",{signal:a}={})=>n(this,l).call(this,{type:s.READ_FILE,data:{path:e,encoding:t}},void 0,a));i(this,"deleteFile",(e,{signal:t}={})=>n(this,l).call(this,{type:s.DELETE_FILE,data:{path:e}},void 0,t));i(this,"rename",(e,t,{signal:a}={})=>n(this,l).call(this,{type:s.RENAME,data:{oldPath:e,newPath:t}},void 0,a));i(this,"createDir",(e,{signal:t}={})=>n(this,l).call(this,{type:s.CREATE_DIR,data:{path:e}},void 0,t));i(this,"listDir",(e,{signal:t}={})=>n(this,l).call(this,{type:s.LIST_DIR,data:{path:e}},void 0,t));i(this,"deleteDir",(e,{signal:t}={})=>n(this,l).call(this,{type:s.DELETE_DIR,data:{path:e}},void 0,t))}on(e,t){e==="log"?n(this,R).push(t):e==="progress"&&n(this,E).push(t)}off(e,t){e==="log"?w(this,R,n(this,R).filter(a=>a!==t)):e==="progress"&&w(this,E,n(this,E).filter(a=>a!==t))}}d=new WeakMap,m=new WeakMap,p=new WeakMap,R=new WeakMap,E=new WeakMap,_=new WeakMap,l=new WeakMap;const Y=async(r,e)=>{var o;const t=await fetch(r);let a;try{const c=parseInt(t.headers.get(HeaderContentLength)||"-1"),h=(o=t.body)==null?void 0:o.getReader();if(!h)throw ERROR_RESPONSE_BODY_READER;const g=[];let v=0;for(;;){const{done:b,value:L}=await h.read(),y=L?L.length:0;if(b){if(c!=-1&&c!==v)throw ERROR_INCOMPLETED_DOWNLOAD;e&&e({url:r,total:c,received:v,delta:y,done:b});break}g.push(L),v+=y,e&&e({url:r,total:c,received:v,delta:y,done:b})}const U=new Uint8Array(v);let A=0;for(const b of g)U.set(b,A),A+=b.length;a=U.buffer}catch(c){console.log("failed to send download progress event: ",c),a=await t.arrayBuffer()}return a};async function D(r,e,t=!1,a){const o=t?await Y(r,a):await(await fetch(r)).arrayBuffer(),c=new Blob([o],{type:e});return URL.createObjectURL(c)}async function Z(r){let e;return/data:_data\/([a-zA-Z]*);base64,([^"]*)/.test(r)?e=atob(r.split(",")[1]).split("").map(t=>t.charCodeAt(0)):e=await(await fetch(r)).arrayBuffer(),new Uint8Array(e)}const O="https://unpkg.com/@ffmpeg/core-mt@0.12.6/dist/esm",q="/videos/2.m4v",J=j({name:"App",setup(){const r=k("Click Start to Transcode");let e=k("");const t=new z;console.log(t);async function a(){t.terminate(),r.value="Loading ffmpeg-core.js",t.on("log",({message:c})=>{r.value=c}),await t.load({coreURL:await D(`${O}/ffmpeg-core.js`,"text/javascript"),wasmURL:await D(`${O}/ffmpeg-core.wasm`,"application/wasm"),workerURL:await D(`${O}/ffmpeg-core.worker.js`,"text/javascript")}),r.value="Start transcoding",await t.writeFile("2.m4v",await Z(q)),await t.exec(["-i","2.m4v","test.mp4"]),r.value="Complete transcoding";const o=await t.readFile("test.mp4");await t.deleteFile("2.m4v"),await t.deleteFile("test.mp4"),e.value=URL.createObjectURL(new Blob([o.buffer],{type:"video/mp4"}))}return{video:e,message:r,transcode:a}}}),Q=["src"],K=u("br",null,null,-1);function ee(r,e,t,a,o,c){return T(),N(x,null,[u("video",{src:r.video,controls:""},null,8,Q),K,u("button",{onClick:e[0]||(e[0]=(...h)=>r.transcode&&r.transcode(...h))},"Start"),u("p",null,F(r.message),1)],64)}const te=P(J,[["render",ee]]),re=`<template>\r
...
<span class="line"><span>},</span></span></code></pre></div>`,7),de=JSON.parse('{"title":"视频转换","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"examples/js案例/translate-video/index.md","filePath":"examples/js案例/translate-video/index.md"}'),ie={name:"examples/js案例/translate-video/index.md"},pe=Object.assign(ie,{setup(r){return(e,t)=>{const a=$("show-code");return T(),N("div",null,[ne,ae,se,C(te),C(a,{code:W(re)},null,8,["code"]),oe])}}});export{de as __pageData,pe as default};
