...
<\/script>\r
`,x=y("",3),w=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/js案例/eye-dropper/index.md","filePath":"examples/js案例/eye-dropper/index.md","lastUpdated":null}'),D={name:"examples/js案例/eye-dropper/index.md"},g=Object.assign(D,{setup(l){return(e,o)=>{const r=a("show-code");return s(),p("div",null,[x,n(v),n(r,{code:c(b)},null,8,["code"])])}}});export{w as __pageData,g as default};
