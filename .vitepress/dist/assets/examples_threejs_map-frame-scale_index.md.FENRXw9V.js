...
`,$=J('<h3 id="生成地图边框数据" tabindex="-1">生成地图边框数据 <a class="header-anchor" href="#生成地图边框数据" aria-label="Permalink to &quot;生成地图边框数据&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>等比缩放会显示异常</span></span></code></pre></div>',2),K={class:"details custom-block"},Q=E("summary",null,"代码详情",-1),re=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/threejs/map-frame-scale/index.md","filePath":"examples/threejs/map-frame-scale/index.md","lastUpdated":null}'),Y={name:"examples/threejs/map-frame-scale/index.md"},te=Object.assign(Y,{setup(w){return(o,e)=>{const t=G("show-code");return g(),v("div",null,[$,_(U),E("details",K,[Q,_(t,{code:z(X)},null,8,["code"])])])}}});export{re as __pageData,te as default};
